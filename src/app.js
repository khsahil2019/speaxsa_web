...
db.query(`
  ...
  ALTER TABLE payments ADD COLUMN IF NOT EXISTS gateway_payment_id VARCHAR(200);
  ALTER TABLE payments ADD COLUMN IF NOT EXISTS billing_name VARCHAR(255);
  ALTER TABLE payments ADD COLUMN IF NOT EXISTS billing_email VARCHAR(255);
  ALTER TABLE payments ADD COLUMN IF NOT EXISTS billing_phone VARCHAR(50);
