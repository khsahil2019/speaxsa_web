    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text("SOP Verified Faculty", style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontSize: 22, fontWeight: FontWeight.bold)),
            const SizedBox(height: 4),
            const Text("Every teacher undergoes background verification, camera/audio audits, and demo lectures", style: TextStyle(color: Colors.grey, fontSize: 12.5)),
