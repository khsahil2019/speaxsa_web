  ...
  void _confirmDeleteAccount(BuildContext context) {
    showDialog(
      ...
      builder: (dialogCtx) => AlertDialog(
        ...
        content: const Text(
          "Are you sure you want to permanently delete your parent account? All student linking records, chat messages with teachers, and account history will be permanently erased. This action CANNOT be undone.",
        ),
        actions: [
          TextButton(
