-- ============================================================
-- SPEAXA EDTECH PLATFORM — EXTENDED SEED DATA FOR DEMO/UI
...
INSERT INTO live_classes (id, batch_id, teacher_id, title, class_date, class_time, agora_channel, status, started_at, ended_at, duration_mins, recording_url) VALUES
  ('live_001', 'batch_001', 'teacher_001', 'Chapter 1: Electric Charges and Fields - Introduction', CURRENT_DATE - INTERVAL '1 day', '09:00:00', 'speaxa_batch_001', 'ended', NOW() - INTERVAL '1 day 1 hour', NOW() - INTERVAL '1 day', 60, 'https://res.cloudinary.com/demo/video/upload/dog.mp4'),
  ('live_002', 'batch_001', 'teacher_001', 'Chapter 1: Coulomb Law & Math Practice', CURRENT_DATE + INTERVAL '1 day', '09:00:00', 'speaxa_batch_001', 'scheduled', NULL, NULL, 0, NULL);
...
INSERT INTO payments (id, razorpay_order_id, razorpay_payment_id, student_id, batch_id, course_id, teacher_id, amount, platform_share, teacher_share, commission_type, status, payment_method, billing_name, billing_email, billing_phone) VALUES
  ('pay_001', 'order_Ndjks82bHjks', 'pay_Ndjks92bHjks', 'student_001', 'batch_001', 'course_001', 'teacher_001', 1999.00, 999.50, 999.50, 'standard', 'captured', 'upi', 'Rahul Verma', 'student@speaxa.com', '9222222222');
