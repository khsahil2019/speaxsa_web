        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Role Subtitle with Pill Tag (Exact matching screenshot 1)
              Obx(() => Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Text("Sign in to your ", style: TextStyle(color: Colors.grey, fontSize: 15)),
                  Container(
                    ...
                    child: Text(
                      controller.selectedRole.value.capitalizeFirst!,
                  ...
                  const Text(" account", style: TextStyle(color: Colors.grey, fontSize: 15)),
                ],
              )),
              const SizedBox(height: 28),
